...
*
*/
#define RSDK_LAX_DMA_CMD_CHANNEL 1U
...
*
*/
#define RSDK_LAX_DMA_CRC_CHANNEL 2U
...
*/
#define RSDK_LAX_SIGNAL_TYPE_MASK (0xFF000000)
...
typedef enum
{
	...
	RSDK_LAX_ERR_NO_RES,               	/**< @brief Operation failed due to unavailable resource (e.g. full circular buffer, no sequence Id, full DMA queue)  */
